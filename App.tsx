      ...
      <header className="bg-base-200/50 backdrop-blur-sm shadow-lg sticky top-0 z-10 border-b border-base-300">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight">HTML Product Scraper</h1>
          </div>
        </div>
      </header>
                  ...
                  <div className="space-y-2 h-full overflow-y-auto pr-2">
                    ...
                    <ul className="space-y-2">
                      {scrapedData.map((product, index) => (
                        <li key={index} className="bg-base-200 p-2 rounded text-sm border-l-4 border-base-300" title={product.title}>{product.title}</li>
                      ))}
                    </ul>
                  </div>
                  <div className="space-y-2 h-full overflow-y-auto pr-2">
